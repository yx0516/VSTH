(function (global, factory) {
   ...
   * @property {Float} [resolution] - Resolution in Ã…
   ...
   * @property {Uint8Array} xCoordBig - Encoded x coordinates in Ã…, part 1
   * @property {Uint8Array} xCoordSmall - Encoded x coordinates in Ã…, part 2
   * @property {Uint8Array} yCoordBig - Encoded y coordinates in Ã…, part 1
   * @property {Uint8Array} yCoordSmall - Encoded y coordinates in Ã…, part 2
   * @property {Uint8Array} yCoordBig - Encoded y coordinates in Ã…, part 1
   * @property {Uint8Array} yCoordSmall - Encoded y coordinates in Ã…, part 2
   * @property {Uint8Array} [bFactorBig] - Encoded B-factors in Ã…^2, part 1
   * @property {Uint8Array} [bFactorSmall] - Encoded B-factors in Ã…^2, part 2
   ...
   * @property {Float32Array} xCoordList - List of x coordinates in Ã…
   * @property {Float32Array} yCoordList - List of y coordinates in Ã…
   * @property {Float32Array} zCoordList - List of z coordinates in Ã…
   * @property {Float32Array} [bFactorList] - List of B-factors in Ã…^2
   ...
   * @param {Float} atomData.xCoord - x coordinate in Ã…
   * @param {Float} atomData.yCoord - y coordinate in Ã…
   * @param {Float} atomData.zCoord - z coordinate in Ã…
   * @param {?Float} atomData.bFactor - B-factor in in Ã…^2
