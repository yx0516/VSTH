...
// +build ignore
//
// This build tag means that "go install github.com/golang/image/..." doesn't
...
package main // import "github.com/golang/image/cmd/webp-manual-test"
