...
// Use github.com/golang/text/encoding. Get page body and change it to utf-8
...
// Charset auto determine. Use github.com/golang/net/html/charset. Get page body and change it to utf-8
